...
SRC = modules.f90 allocation.f90 main.f90 fkfun.f90 cadenas.f90 rands.f90 initmpi.f90 kai.f90 factorcurv.f90 free_energy.f90  dielectric.f90 parser.f90 PBC.f90 creador.f90 init.f90 save2disk.f90 kinsol.f90 cadenasMD.f90
...
# FFLAGS= -Wall 
# FFLAGS= -O3 
 FFLAGS= -O3# -g -fbacktrace -fbounds-check # -ffpe-trap=zero,overflow,underflow 
