...
print("------------------------------------------------------------------------------------------------")
print("Possible types of martini beads: Qda  Qd  Qa  Q0  P5  P4  P3  P2  P1  Nda  Nd  Na  N0  C5  C4  C3  C2  C1 SC4 EO")
print("Please use exactly the same spelling, including lower and upper cases.")
print("------------------------------------------------------------------------------------------------")
print("")

n=0
n = int(input("Number of types of beads (including solvent): "))


name=""
bead_type_index=numpy.zeros(n, dtype='uint8')
vol_th=numpy.zeros(n)
...
factor = float(input("Enter factor of normalization (tipicamente 0.36):"))
